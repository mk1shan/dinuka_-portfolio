      ...
      <div className="w-full max-w-4xl">
        ...
        >
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-white leading-tight text-center sm:text-left">
              Capturing Life's{" "}
              <span className="bg-gradient-to-r from-primary-400 to-primary-600 bg-clip-text text-transparent">
                Beautiful Moments
              </span>
            </h1>
            <p className="text-lg sm:text-xl text-white/70 max-w-xl mx-auto sm:mx-0 text-center sm:text-left">
